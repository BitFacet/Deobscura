...
internal data class ControlFlowFacts(
    ...
    companion object {
        fun build(graph: ControlFlowGraph, flow: SsaControlFlowGraph, expression: ExpressionAnalysis): ControlFlowFacts? {
...
internal fun postDominators(blocks: Set<BasicBlockId>, outgoing: Map<BasicBlockId, List<ControlFlowEdge>>): Map<BasicBlockId, Set<BasicBlockId>> {
    val all = blocks.toSet()
...
internal fun immediatePostDominator(block: BasicBlockId, postDominators: Map<BasicBlockId, Set<BasicBlockId>>): BasicBlockId? {
